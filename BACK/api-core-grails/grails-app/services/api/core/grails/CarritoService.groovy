...
class CarritoService {
    ...
    /********************************************************************/
    public ArrayList getMethod(String idUsuarioParams) {
        ...
        ArrayList<Item> listaItems = carrito.items
        def itemsCarrito = itemService.armarListaItemCarrito(listaItems)
    ...
    public Carrito getCarritoByUser(String userId){
    ...
    public Carrito createCarrito(String userId, List<Item> items){
    ...
    /********************************************************************/
    public Carrito putMethod(String idUsuarioParams, String idItem, Integer nuevaCantidad) {
    ...
    /********************************************************************/
    public Carrito deleteMethod(String idUsuarioParams) {
        UserService userService = new UserService()

        //por carritoService me fijo si ya existe un carrito para el usuario
        Carrito carrito = getCarritoByUser(idUsuarioParams)

        carritos.remove(carrito.idCarrito)
        return carrito
    }

    /********************************************************************/
    public Carrito postMethod(String idUsuarioParams, String idItem) {
        UserService userService = new UserService()
        ...
        if (flag) {
            ...
            Item itemNuevo = itemService.getInfoItem(idItem)
            if (itemNuevo == null){
    ...
    /*
    private void fitemNuevoailIfInvalid(String name, String img) throws IllegalArgumentException{
